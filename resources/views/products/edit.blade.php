                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form method="POST" action="{{ route('products_temp.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-input mt-1 block w-full" id="name" name="ProductName"
                        ...
                        <div class="mb-4">
                            <label for="serial_number" class="block text-sm font-medium text-gray-700">Serial
                                Number:</label>
                            <input readonly type="text" class="form-input mt-1 block w-full" id="serial_number"
                                name="serial_number" value="{{ $product->serial_number }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="new_quantity" class="block text-sm font-medium text-gray-700">New
                                Stock/Quantity:</label>
                            <input type="number" class="form-input mt-1 block w-full" id="new_quantity"
                                name="new_quantity" value="" required>
                        </div>
