...
<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    {{-- Entities --}}
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#entities" role="button" aria-expanded="false"
            ...
            <span class="item-name">Entities</span>
            <i class="right-icon">
        ...
        <ul class="sub-nav collapse" id="entities" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('entities.index')) }}" href="{{ route('entities.index') }}">
                    <i class="icon">
                    ...
                    <span class="item-name">Manage Entities</span>
                </a>
            </li>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="roles" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('roles.index')) }}" href="{{ route('roles.index') }}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                            fill="currentColor">
                            <g>
    ...
    {{-- Logs --}}
    {{-- @if (Auth::user()->role->permissions->contains('name', 'Manage Logs')) --}}
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#logs" role="button" aria-expanded="false"
            aria-controls="sidebar-user">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
        ...
        <ul class="sub-nav collapse" id="logs" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{ activeRoute(route('audit-logs.index')) }}"
                    ...
                    <span class="item-name">View Logs</span>
                </a>
            </li>
        ...
        <a class="nav-link" href="{{ route('logout') }}"
            ...
            <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M14 2v4a2 2 0 0 0 2 2h3l-4 4-4-4h3a2 2 0 0 0 2-2V2z"></path>
                    <path d="M7 7h-4a2 2 0 0 0-2 2v8"></path>
                    <path d="M10 21v-8a2 2 0 0 1 2-2h4"></path>
                </svg>
            </i>
