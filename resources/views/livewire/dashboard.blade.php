...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <div class="bg-gray-200 rounded-lg shadow-md p-6 cursor-pointer">
        <h3 class="text-xl font-semibold mb-4">Total Items</h3>
    ...
    {{-- Total Products --}}
    <div class="bg-gray-200 rounded-lg shadow-md p-6 cursor-pointer" >
        <h3 class="text-xl font-semibold mb-4">Items Pending Approval</h3>
    ...
    {{-- Total Invoices --}}
    {{-- surround with route sales-items.index  --}}
    {{-- <a href="{{ route('sale-items.index') }}"> --}}
        <div class="bg-gray-200 rounded-lg shadow-md p-6 cursor-pointer" >
            <h3 class="text-xl font-semibold mb-4">UnOffered Items</h3>
            <p class="text-2xl font-bold">{{ number_format($totalUnOffered) }}</p>
        </div>
    {{-- </a> --}}
    ...
    @if(Auth::user()->role->id == 1) 
    <div class="bg-gray-200 rounded-lg shadow-md p-6 cursor-pointer" >
        <h3 class="text-xl font-semibold mb-4">Total Businesses</h3>
