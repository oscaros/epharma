                    ...
                    <div class="col-span-1 md:col-span-1">
                        <div class="bg-white rounded-lg shadow-md">
                            <div class="bg-green-500 py-4 px-6 rounded-t-lg">
                                <h4 class="mb-0 text-xl font-semibold text-black">Overall Report</h4>
                            </div>
                            <div class="p-6">
                                <ul class="divide-y divide-gray-200">
                                    ...
                                    <li class="flex justify-between items-center py-3">
                                        ...
                                        <span class="bg-green-500 text-black px-3 py-1 rounded">{{ number_format($totalCustomers, 2) }}</span>
                                    </li>
                                    <li class="flex justify-between items-center py-3">
                                    ...
                                    <li class="flex justify-between items-center py-3">
                                        ...
                                        <span class="bg-green-500 text-black px-3 py-1 rounded">{{ number_format($pendingInvoices, 2) }}</span>
                                    </li>
                                    <li class="flex justify-between items-center py-3">
