            ...
            <div class="col-span-1 md:col-span-2 lg:col-span-3">
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="mb-3">
                            <label for="first_name" class="block text-sm font-medium text-gray-700">First Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-input mt-1 block w-full rounded-md" id="first_name"
                                name="first_name" placeholder="Enter user first name" required>
                        </div>

                        {{-- add field last name --}}
                        <div class="mb-3">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Last Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-input mt-1 block w-full rounded-md" id="last_name"
                                name="last_name" placeholder="Enter user last name" required>
                        </div>

                        <div class="mb-3">
                            <label for="email" class="block text-sm font-medium text-gray-700">Email <span class="text-danger">*</span></label>
                            
                            <input type="email" class="form-input mt-1 block w-full rounded-md" id="email"
                                name="email" placeholder="Enter user email" required>
                        </div>

                        {{-- add field phone number --}}
                        <div class="mb-3">
                            <label for="phone_number" class="block text-sm font-medium text-gray-700">Phone <span class="text-danger">*</span>
                                Number</label>
                            
                            <input type="text" class="form-input mt-1 block w-full rounded-md" id="phone_number"
                                name="phone_number" required placeholder="Enter user phone number">
                        </div>

                        <!-- Role select field with Select2 -->
                        <div class="mb-3">
                            <label for="role_id" class="block text-sm font-medium text-gray-700">Role <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="department_id" class="block text-sm font-medium text-gray-700">Service
                                Point <span class="text-danger">*</span></label>
                            <select class="form-select w-full rounded-md" id="department_id" name="department_id"
                                required>
                        ...
                        @if (auth()->user()->role_id == 1)
                            ...
                            <div class="mb-3">
                                <label for="entity_id" class="block text-sm font-medium text-gray-700">Entity <span class="text-danger">*</span></label>
