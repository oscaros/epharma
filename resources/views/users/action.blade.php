<div class="flex align-items-center list-User-action">
    <!-- View Action -->
    <a class="btn btn-sm btn-icon btn-info" data-bs-toggle="tooltip" title="View User" href="{{ route('users.show', $id) }}">
    ...
    <!-- Delete Action -->
    <a class="btn btn-sm btn-icon btn-danger" onclick="confirmDelete('{{ $id }}')" data-bs-toggle="tooltip" title="Delete User" href="#">
        <span class="btn-inner">
